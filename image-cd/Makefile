...
# 
# Includes build rules for arith40.
#
...
all: luma_cos bitpack io 40image-6
...
luma_cos: luma_cos_tests.o pixConversions.o 
		$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS) 

clean:
		rm -f luma_cos bitpack io 40image *.o

bitpack: bitpack_tests.o bitpack.o
	    $(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

io: io_tests.o compressed_io.o bitpack.o
	    $(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

40image-6: 40image.o compress40.o compressed_io.o pixConversions.o bitpack.o \
	a2plain.o uarray2.o floatIntScale.o
	    $(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
